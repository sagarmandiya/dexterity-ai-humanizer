      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-600 mb-4">
              Making AI-generated text sound human with advanced language processing.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#demo" className="text-gray-600 hover:text-primary transition-colors">Try It</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row md:items-center justify-between">
          <p className="text-gray-500">
            &copy; {currentYear} AI Humanizer. All rights reserved.
          </p>
